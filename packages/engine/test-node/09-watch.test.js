...
import { sortTaskQueue } from '../src/Watcher.js';
import { setupTestEngine } from './test-helpers.js';

const { expect } = chai;

describe('Engine start', () => {
  describe('Sorts Task Queue', () => {
    it('[delete] sorts delete tasks by nested level', async () => {
      const sorted = sortTaskQueue([
        ['/docs/a/aa.rocket.js', { type: 'delete' }],
        ['/docs/a/aa/aa.rocket.js', { type: 'delete' }],
        ['/docs/a/ab/ab.rocket.js', { type: 'delete' }],
        ['/docs/b/ba/baa/baa.rocket.js', { type: 'delete' }],
        ['/docs/b/bb/bb.rocket.js', { type: 'delete' }],
        ['/docs/about/me.rocket.js', { type: 'delete' }],
      ]);
    ...
    it('[delete] sorts delete tasks index files always last within the folder', async () => {
      const sorted = sortTaskQueue([
        ['/docs/a/index.rocket.js', { type: 'delete' }],
        ['/docs/a/aa.rocket.js', { type: 'delete' }],
        ['/docs/a/aa/aaa.rocket.js', { type: 'delete' }],
        ['/docs/a/aa/index.rocket.js', { type: 'delete' }],
        ['/docs/a/aa/aab.rocket.js', { type: 'delete' }],
        ['/docs/a/aa/aac.rocket.js', { type: 'delete' }],
      ]);
