 ...
 */
async function cleanupAutoGeneratedFiles(filePath) {
  ...
  if (filePath.endsWith('.rocket.html')) {
    const htmlTemplateFilePath = filePath.replace('.rocket.html', '-converted-html.js');
...
async function renderFile({ filePath, outputDir, inputDir, renderMode = 'development' }) {
  ...
  await cleanupAutoGeneratedFiles(filePath);
